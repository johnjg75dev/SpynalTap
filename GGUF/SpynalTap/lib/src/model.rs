...
impl ModelFormat {
    pub fn from_path(path: &Path) -> Self {
        match path.extension().and_then(|e| e.to_str()) {
            ...
            Some(ext) if ext.eq_ignore_ascii_case("safetensors") || ext.eq_ignore_ascii_case("st") => {
                Self::Safetensors
            }
            _ => Self::Gguf,
        }
...
pub enum TensorDtype {
    ...
    Iq2Xxs, Iq2Xs, Iq3Xxs, Iq3S, Iq4Nl, Iq4Xs, Iq1S,
    Tq1_0, Tq2_0,
    Unknown(u32),
}
...
pub enum MetadataValue<'a> {
    ...
    F32(f32), Bool(bool), String(&'a str), U64(u64), I64(i64), F64(f64),
}
