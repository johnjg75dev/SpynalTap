...
pub enum GgmlType {
    ...
    Iq2Xxs = 16, Iq2Xs = 17, Iq3Xxs = 18, Iq3S = 19, Iq4Nl = 20, Iq4Xs = 21,
    I8 = 24, I16 = 25, I32 = 26, I64 = 27, F64 = 28, Iq1S = 29, Bf16 = 30,
    Tq1_0 = 34, Tq2_0 = 35,
    Unknown(u32),
}
...
impl GgmlType {
    ...
    pub fn from_u32(v: u32) -> Self {
        match v {
            ...
            14 => Self::Q6K, 15 => Self::Q8K, 16 => Self::Iq2Xxs, 17 => Self::Iq2Xs,
            18 => Self::Iq3Xxs, 19 => Self::Iq3S, 20 => Self::Iq4Nl, 21 => Self::Iq4Xs,
            24 => Self::I8, 25 => Self::I16, 26 => Self::I32, 27 => Self::I64,
            28 => Self::F64, 29 => Self::Iq1S, 30 => Self::Bf16,
            34 => Self::Tq1_0, 35 => Self::Tq2_0,
    ...
    pub fn to_tensor_dtype(self) -> TensorDtype {
        match self {
            Self::F32 => TensorDtype::F32, Self::F16 => TensorDtype::F16,
            Self::Bf16 => TensorDtype::Bf16, Self::F64 => TensorDtype::F64,
            Self::I8 => TensorDtype::I8, Self::I16 => TensorDtype::I16,
            Self::I32 => TensorDtype::I32, Self::I64 => TensorDtype::I64,
            Self::Q4_0 => TensorDtype::Q4_0, Self::Q4_1 => TensorDtype::Q4_1,
            Self::Q5_0 => TensorDtype::Q5_0, Self::Q5_1 => TensorDtype::Q5_1,
            Self::Q8_0 => TensorDtype::Q8_0, Self::Q8_1 => TensorDtype::Q8_1,
            Self::Q2K => TensorDtype::Q2K, Self::Q3K => TensorDtype::Q3K,
            Self::Q4K => TensorDtype::Q4K, Self::Q5K => TensorDtype::Q5K,
            Self::Q6K => TensorDtype::Q6K, Self::Q8K => TensorDtype::Q8K,
            Self::Iq2Xxs => TensorDtype::Iq2Xxs, Self::Iq2Xs => TensorDtype::Iq2Xs,
            Self::Iq3Xxs => TensorDtype::Iq3Xxs, Self::Iq3S => TensorDtype::Iq3S,
            Self::Iq4Nl => TensorDtype::Iq4Nl, Self::Iq4Xs => TensorDtype::Iq4Xs,
            Self::Iq1S => TensorDtype::Iq1S,
            Self::Tq1_0 => TensorDtype::Tq1_0, Self::Tq2_0 => TensorDtype::Tq2_0,
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            Self::F32 => "F32", Self::F16 => "F16", Self::Bf16 => "BF16", Self::F64 => "F64",
            ...
            Self::Q2K => "Q2_K", Self::Q3K => "Q3_K",
            Self::Q4K => "Q4_K", Self::Q5K => "Q5_K",
            Self::Q6K => "Q6_K", Self::Q8K => "Q8_K",
            Self::Iq2Xxs => "IQ2_XXS", Self::Iq2Xs => "IQ2_XS",
            Self::Iq3Xxs => "IQ3_XXS", Self::Iq3S => "IQ3_S",
            Self::Iq4Nl => "IQ4_NL", Self::Iq4Xs => "IQ4_XS", Self::Iq1S => "IQ1_S",
    ...
    pub const fn block_size(self) -> usize {
        match self {
            ...
            | Self::Iq2Xxs | Self::Iq2Xs | Self::Iq3Xxs | Self::Iq3S
            | Self::Iq4Xs | Self::Tq1_0 | Self::Tq2_0 | Self::Iq1S => 256,
            Self::Unknown(_) => 1,
        }
    }
    ...
    pub const fn block_bytes(self) -> Option<usize> {
        Some(match self {
            ...
            Self::Q4K => 144, Self::Q5K => 176, Self::Q6K => 210, Self::Q8K => 292,
    ...
    pub fn to_u32(self) -> u32 {
        match self {
            ...
            Self::Q2K => 10, Self::Q3K => 11, Self::Q4K => 12, Self::Q5K => 13,
            Self::Q6K => 14, Self::Q8K => 15,
            Self::Iq2Xxs => 16, Self::Iq2Xs => 17, Self::Iq3Xxs => 18, Self::Iq3S => 19,
            Self::Iq4Nl => 20, Self::Iq4Xs => 21,
            Self::I8 => 24, Self::I16 => 25, Self::I32 => 26, Self::I64 => 27,
            Self::F64 => 28, Self::Iq1S => 29, Self::Bf16 => 30,
            Self::Tq1_0 => 34, Self::Tq2_0 => 35,
            Self::Unknown(v) => v,
        }
    }
}
...
pub enum MetaValue {
    ...
    F32(f32), Bool(bool), String(String), U64(u64), I64(i64), F64(f64),
    Array(ArrayValue),
}
...
fn ty_size_guess(ty: GgmlType) -> usize {
    match ty {
        GgmlType::F32 => 4, GgmlType::F16 => 2, GgmlType::Bf16 => 2, GgmlType::F64 => 8,
